...
key_ingredients: "Heartleaf Extract (Houttuynia Cordata), Jojoba Oil, Olive Fruit Oil, Grape Seed Oil, Sunflower Seed Oil, Macadamia Oil, Moringa Oil, Tocopherol (Vitamin E), Turmeric Root Extract"
free_from: "Paraben-free, silicone-free, sulfate-free"
spf_rating: ""
vegan: false
...
description_short: "The ideal first-step cleanser. Plant-based oils emulsify on contact with water, lifting makeup and SPF cleanly. Non-comedogenic, skin-calming, 200ml."
description_full: |
  A great skincare routine starts with a great cleanse — and this is one of the best first-step cleansers we've come across.
...
ysp_thoughts: |
  We needed a cleansing oil that could sit confidently next to the rest of the Anua lineup — and this does exactly that. It does its job without any fuss: it removes everything, rinses clean, and leaves skin feeling like skin, not like it's just been scrubbed.

  The emulsification is satisfying in a way that's hard to explain until you try it. You massage in the oil, add a little water, and it turns milky and lifts off cleanly — no greasy residue, no tight feeling, nothing left behind. For a first-step cleanser, that's the entire brief, and it nails it.

  It also pairs naturally with the other Anua products we carry. If you're already using the Heartleaf Calming Cream or the PDRN serum, starting the routine with this makes sense — same philosophy, same skin-first approach.
